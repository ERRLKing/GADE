...
const buildCandidateGoals_1 = require("./buildCandidateGoals");
const rankGoals_1 = require("./rankGoals");
function nearestPoi(state, type) {
    const points = type
...
function fallbackDecision(state, assessment) {
    const ranked = (0, rankGoals_1.rankGoals)((0, buildCandidateGoals_1.buildCandidateGoals)(state, assessment));
