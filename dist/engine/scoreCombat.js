...
exports.scoreCombat = scoreCombat;
function scoreCombat(state, threatScore) {
    ...
    const recommendedStance = confidence >= 0.75 ? 'engage' : confidence >= 0.55 ? 'defensive' : confidence >= 0.35 ? 'observe' : 'avoid';
