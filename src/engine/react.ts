...
function nearestThreat(state: UniversalAgentState) {
  return [...state.perception.entities]
    .filter((e) => e.threatScore > 0.2)
    .sort((a, b) => a.distance - b.distance)[0]
}

export function react(state: UniversalAgentState, assessment: Assessment): Decision | null {
